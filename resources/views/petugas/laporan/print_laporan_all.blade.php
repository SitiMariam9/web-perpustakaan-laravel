    ...
    <table border="0" width="100%">
        <tr>
            ...
            <td width="90%" align="center">
                <h5>DINAS PENDIDIKAN PEMERINTAH KABUPATEN KARO</h5>
                <h5>MTSN KARO</h5>
                <h6>Alamat : Gg. Madrasah No.8, Gung Leto, Kec. Kabanjahe, Kabupaten Karo, Sumatera Utara 22112</h6>
            </td>
        </tr>
    </table>
    <hr>
    <center>
        <h5>LAPORAN PEMINJAMAN SELURUH SISWA MTSN KARO</h5>
    </center>

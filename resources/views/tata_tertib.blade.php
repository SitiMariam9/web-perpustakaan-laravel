                    ...
                    <div class="panel-group symb" id="accordion">
                        <div class="panel panel-default">
                            ...
                            <div id="ac1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <p>
                                     Tata Terbit Dalam Melakukan Transaksi Peminjaman Buku di MTSN KARO
                                     yang harus Di Patuhi Oleh Seluruh Siswa MTSN KARO
                                   </p>
                                    <ul>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="ac2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>
                                         Tata Tertib bagi Siswa MTSN KARO dalam proses Pengembalian Buku di Perpustakaan
                                         yang wajib di patuhi oleh seluruh siswa / anggota Perpustakaan MTSN KARO
                                    </p>
                                    <ul>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#ac3">
                                        Tata Tertib Pendaftaraan Anggota Perpustakaan
                                    </a>
                                </h4>
                            </div>
                            <div id="ac3" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>
                                        Tata Tertib Siswa Dalam Melakukan Pendaftaraan sebagai Anggota Perpustakaan di MTSN KARO
                                    </p>
                                    <ul>
                                        <li>Siswa MTSN KARO</li>
                                        <li>Minimal Siswa Berada pada kelas 8 MTS</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
